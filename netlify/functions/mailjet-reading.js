...
exports.handler = async function(event, context) {
  ...
  try {
    ...
    const readingUrl = 'https://www.themagickmechanic.com/magick-cat-oracle-daniel-boutros';

    // Create professional HTML template with brand colors and fonts + SOCIAL SHARING
    const htmlTemplate = `
    <!DOCTYPE html>
    <html lang="en">
    <head>
        ...
        <style>
            ...
            .social-sharing-section {
                background: linear-gradient(135deg, #0A2E44 0%, #12545D 100%);
                padding: 30px;
                margin: 30px 0;
                border-radius: 12px;
        ...
        <div class="email-container">
            ...
            <div class="content">
                ...
                <div class="social-sharing-section">
                    <h3 class="social-sharing-title">Share Your Reading ✨</h3>
                    <p class="social-sharing-text">
                        Spread the mystical energy! Invite your friends to discover their own oracle wisdom and explore their path.
                    </p>
                    <a href="${readingUrl}" class="social-cta-button">Get Your Own Reading</a>
                </div>
            </div>
    ...
    textContent += '\n\n━'.repeat(50) + '\n';
    textContent += 'SHARE YOUR READING ✨\n\n';
    textContent += 'Spread the mystical energy! Invite your friends to discover their own oracle wisdom.\n';
    textContent += `Get your own reading: ${readingUrl}\n\n`;
    textContent += '━'.repeat(50) + '\n';
