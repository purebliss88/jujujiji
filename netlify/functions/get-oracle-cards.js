  ...
  try {
    ...
    const cards = [
      ...
      },  
      {
        ...
        "moon_meaning": "The shadow of habitual romanticism hides deep wounds bound in misunderstood innocence.\n\nThis being can often fall in traps of seeking only that which arouses or excites, rather than what soothes and stabilizes. This can lead to an addiction of chasing a challenge, such as a person or ideal, as a source of a high.\n\nWhat happens when the focus of this one's affections is pursued from an egoic wound? What happens when the 'prize' is won?\n\nThe high is hit, and the flames of passion fade. Discomfort and disastisfaction arises and their ego, expecting to feel good, is confused. If a person was the subject of suave one's affections, they may be neglected and feel hurt - a whiplash tainting any romance.\n\nA deep need to prove self worth is often the root of this one's cycle. One avoids discomforts about the self through pursuing the drug of proving one is worthy of some one, some thing, some how.\n\nThese behaviors are best understood rather than demonized. This behaviour is seeking to fill a deep fear of unlovability or undeservedness.\n\nThis is not a project for you to solve, but a living lesson to give grace, kindness and thanks while you move forward, to somwhere more loving, elsewhere." 
      }, 
      {
        "id": "oracle",
        "title": "The Oracle",
