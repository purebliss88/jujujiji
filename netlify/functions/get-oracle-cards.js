  ...
  try {
    ...
    const cards = [
      ...
      {  
        ...
        "moon_meaning": "The gift of a rich, multi-layered perception in this version of society, can come with the challenge of self-doubt. Are my feelings valid? Do I fit here? 'This world that tells me I don't fit here - how do I fit in it?'\n\nHow does anyone sit with the constant messaging to identify with ideas that don't fit their experience of self?\n\nSelf doubt can often be a stealth protector. 'If I mute my craziest truth, people will accept me'. But if you don't accept you, how will those who love all you're about, find you? \n\nThere are always those who care, whether you know them today or not. In low times, it can be hard to remember this. \n\nThe more you let yourself be you, as you know yourself to be right now, the more people who appreciate you will emerge. Self-doubt can arise as a constant shadow, when one is committed to the process of embodying their true unique self."
      }, 
      {   
        "id": "highness",
        "title": "Her Highness",
      ...
      },
      {
        ...
        "location": "Your team",
        "element": "Air",
        "sun_meaning": "A master who can be at peace and thrive within chaos. The 'show-runner'. The grand conductor. This one has an ability to maintain level-headedness as the eye of the storm.\n\nThis being is one who can be in ease within the intensities of chaos and disarray. They are connected with the flow of creation. They know how to connect with the true nature of their team members, the unexpected and all else inebtween.\n\nThey can weave 'chaos', accidents, and all that seems wild and dangerous into an almost musical, harmonious flow. They treat 'mistakes' or problems as gifted parts of the grand design, using them as opportunities to birth meaningful parts of the creation.\n\nThey thrive in the uncertain, knowing success will come through revealed steps of a path, where the ending is not yet in easy sight.\n\nTo be embodied with this skillset is to be capable of great art, team leadership, a capacity for grand change and impactful co-creations.\n\nThis is one who knows how to be in service to the creation while in respect of all and who appears to help make it.",
        "moon_meaning": "Sometimes mastery of chaos can lead to a symphony of exhilirating highs and lows and a sense of comfort when within it. This can make moments of stillness a challenge.\n\nWhen the highs go away, are you able to enjoy the nothing? Does the elimination of stimuli create discomfort for you?\n\nPlay and dance are great ways to fill that void, but what about when the need for the self is simply to be. To witness the aftermath of self as victorious from the chaos. To be able to witness the chaos outside and not need to connect with it. To be able to expand and contract when the self needs. \n\nIf support is needed to come back to yourself and peace, remember to allow vulnerability so you can ask for that support. And it's ok if it comes from those who you are typically a pillar for."
      },
      {
        "id": "devotee",
        "title": "The Devotee",
      ...
      },
      {
        ...
        "moon_meaning": "It is most beneficial when to hunt, hustle or chase is utilized as a temporary strategy, rather than when under the compulsion of continual pressure to survive. \n\nThis one may appear to be in love with the thrill of constantly setting goals to achieve, though if it becomes a lifestyle, there may be a hidden harmful belief compelling a destructive cycle of pressure.\n\nIf caught in this cycle, this one can easily burn themselves out and harm their health. Worse, they can lose touch with their own essence and can easily lose alignment with who they truly are.\n\nIf you've heard the term 'hungry ghost', the pressure / survival cycle can inadvertently create one, often hiding in patterns of achievement for achievement's sake. This can create a hollow existence of achieving without heart-felt satisfaction.\n\nThe being you drew this card for is stuck in a survival or pressure habit cycle and can break it if they choose. Once they do, the path, and a true sense of freedom, should start to emerge." 
      },
      { 
        "id": "earthdad",
      ...
      { 
        "id": "dmtcat",
        "title": "God Cat",
        "image_url": "https://images.squarespace-cdn.com/content/63851693a72d772add4d6c00/04b43d25-93fe-42d2-99fc-15a7bf8783b1/dmtkitty.png",  
        "time": "Non existent",
        "energy": "Dissolusion or Illusion",
        "location": "Universe",
        "element": "Everything, Nothing",
      ...
      { 
        ...
        "moon_meaning": "In the pursuit of wealth, we can often fall in a trap of not feeling like we're doing enough, or are enough. This can look like getting in a cycle of looking for opportunities, as if to mitigate the in-between 'non-productive' moments.\n\nHowever, to receive wealth, we sometimes need to contract. When we breathe, our lungs first expand to take in oxygen, then exhale to let it out as carbon dioxide. We cannot just breathe in, or just breathe out - both are needed to stay alive.\n\nIn the path of attaining wealth, trust and faith are the end of the breath out. It may seem practical and wise to metaphorically breathe in as much air as possible all the time.\n\nUnder the hood, is there desperation? A lack of faith you're supported? A lack of trust that you can ever relax and receive from life? If there is, that's the seed being planted in what you're putting out into the world.\n\nDo you think that seed will grow into prosperity, or disappointment? This is a time to contract your energy and trust you will receive.\n\nRelax, trust and receive. You ARE enough. You have done enough. It will come. Take this moment to breathe and rest. Relax and you will receive." 
      },
      {
        "id": "Jon Snow",
        "title": "The Reluctant Leader",
        "image_url": "https://images.squarespace-cdn.com/content/63851693a72d772add4d6c00/163fb2dc-6a3c-4247-bdb7-7080320c7a64/John+Snow.png",  
        "time": "The Present",
        "energy": "Surrender or Anxiety",
        "location": "Up the hill",
        "element": "Spirit",
        "sun_meaning": "This is the heart-driven leader. This is the type leader the world desperately needs to obsolesce the dominance-driven top down structures, bringing servant-leader structures into the norm.\n\nThis one is often reluctant to step into leadership as the one truly in their heart feels so much in all aspects of the emotional spectrum - both a blessing and a curse.\n\nIn our common society-approved ideas of leadership - which are conflated with 'rule' or ideas of dominance and control - this is often labeled as 'weakness'.\n\nWhen one can feel and be present, honest and integrated in all parts of the feeling spectrum - both the comfortable and uncomfortable, with maturity - leadership is inclusive, connective and compassionate. This type of presence can activate the strengths, loyalties and best performance of those in the led collective.\n\nThe impact of this kind of leader is often greater than they'll ever know, and their presence is typically seen as a gift.\n\nThe one you drew this oracle for, is on the path to become this, or already is this type of leader.\n\nThis being is naturally talented in bringing out the absolute best in others and creating a healthy team or tribal culture grounded in connection and human-first values.",
        "moon_meaning": "This one's reluctance to step into leadership is preventing them being in the life meant for them. They are needed and it's time for them to rise up and overcome doubt, whether they feel ready or not.\n\nThe most influential, inspiring and transformative leaders are connected and grounded through their heart and truly 'see' those on the journey with them. They're not the domineering, narcisistic types seen glorified in movies - those people have had their time and era.\n\nLeading with heart means facing yourself continually and growing - it rarely feels like a mastered space of arrival, and more like a continual process of self-refinement, often positively impacting others when integrity is this person's compass 'North'. Speaking truth, speaking up for the others, being vulnerable and going against 'the norm'. It is not a path for the weak.\n\nThis one must lead as example, which requires a process of continual transformation and egoic refinement through shedding.\n\nWhile challenging, it's true gift is that eventually, any doubt this one has held in themself will not be able to survive.\n\nHow can it, when this one has overcome so much within themselves and is still able to be present in their heart?\n\nThis is why this one's leadership is so effective; it is rooted in lived wisdom, born through struggle and lives through capacity to hold great empathy, be in service and see with clarity. Doubt loses oxygen when this being persists." 
      }, 
      {
        "id": "Self Study",
        "title": "The Meister",
        "image_url": "https://images.squarespace-cdn.com/content/63851693a72d772add4d6c00/fa22480d-5a33-4282-86cb-ebe84e87de08/archiv2.png",  
        "time": "A planned later time",
        "energy": "Truth, Lies",
        "location": "You",
        "element": "Air, Earth",
      ...
      }, 
      {
        "id": "Lawyer",
        "title": "The Lawyer",
        "image_url": "https://images.squarespace-cdn.com/content/63851693a72d772add4d6c00/277b5700-417c-41de-b64f-e45e11c394d8/cat+lawyer_.png",  
        "time": "When it's right",
        "energy": "Rules or Freeform",
        ...
        "moon_meaning": "Sometimes rules are no longer useful to serve the needs of a social contract. When people and their surrounding world evolves, so do their needs.\n\nSometimes the agreed-upon rules did not truly fit the needs of the collective identity and only served the ones making the rules.\n\nAny rules or laws that do not consider and contain the safety of the whole which they are meant to serve and protect, are ideas that need to be changed or abolished completely.\n\nRules are meant to assist harmony of the collective identity. If they don't, they verge on enabling an unhealthy dictatorial structure. When a dictatorial, controlling structure or similar is present, erosion of connective, healthy dynamics will occur naturally - no system in nature thrives under such dynamics.\n\nIf the one you drew this for is residing in an unhealthy structure of law or rule, this is a sign for them to break the rules, take efforts to change their structure immediately, or build their own structure to be within, outside of the dysfunction present." 
      }, // Sep 22
      {
        "id": "Addict",
        "title": "The addict",
      ...
      },
      {
        "id": "thefather",
        "title": "The Father",
        "image_url": "https://images.squarespace-cdn.com/content/63851693a72d772add4d6c00/f49736bb-cd92-451e-b767-66aaba4a1d0c/7.png",  
        "time": "Present",
        "energy": "Presence or Abandonment",
        "location": "The Structure",
        "element": "All",
        "sun_meaning": "The Father represents that energy which resources, protects, holds and is unwaveringly present when needed.\n\nIt is the part of nature that activates and initiates, and then holds the structure allowing the initiation to be contained.\n\nThis being is calling you to invite those qualities into your life, either through you or to you. This energy is needed for your next phase, whether it's to lead in a way where you are giving this to others, or to be held in this so you can blossom a part of you that needs that level of strength to safely come to form.\n\nAllow this energy to initiate this next phase of your being now. It is time.",
        "moon_meaning": "This being's shadow lays in uncertainty and ungroundedness. When there is no structure, there's no containment and therefore protection is shaky at best.\n\nEven in good nature, a Father cannot be the strength for others if they can't resource their own successfully. When the one this oracle is for is struggling to provide these energies for themselves, the need is to create conditions that call it back for themselves.\n\nIf a Father does not have systems or nerves that can hold this level of capacity, they will be a weak structure and they will fail to contain and resource for anything outside of themselves. The remedy is to call in the support needed to re-Father the self, piece by piece.\n\nThe Universe is a tangible concept when it's trusted, but it demands we have faith even at the lowest points, and the ability to be present enough to hear it.\n\nThe first Father was the Universe; ask and you shall receive. Trust and you shall be supported." 
      }, // Sep 2 addition
      {
        "id": "builder",
        "title": "The One Who Builds",
        "image_url": "https://images.squarespace-cdn.com/content/63851693a72d772add4d6c00/df640608-e7bc-4486-9bb2-e449abdf698b/10.png",  
        "time": "Gradual",
        "energy": "Building and Perfectionism",
        "location": "Here",
        "element": "Earth",
        "sun_meaning": "The builder is all about creating support for a vision, and the lives of self or others.\n\nThey might do it through building a business, a home or a family environment. A social experience or even a community. Their goal is to bring form to a creation, and that creation serves a support role, either directly or as reward.\n\nThe one this being is drawn for is one you can trust to create support for you. The only thing you can't count on is time. Building may seem linear, but no creation comes to form without meeting resistance. The resistance is neccessary to test its strengths and foundations, and the greater the ambitions of support, the greater the storms.\n\nHowever, one who perseveres through these storms and does not falter from the goal will create something lasting, sturdy and bountiful.\n\nHold faith when the storms arise. If they take out parts of even the whole structure, then it needed to be broken. This is so the hidden weaknesses in foundation can be addressed, improved and rebuilt stronger, newly informed by the storms that collapsed them.",
        "moon_meaning": "While possessing traits such as strength, dedication and focus, the builder can also lose sight of the big picture.\n\nThe builder often dedicates themselves to a vision to bring into form, but sometimes the form is no longer valid and pivoting is required. Sometimes the pivot is partial and sometimes it's total.\n\nIf this shadow has found you, know that the remedy is to step away from the build and reconnect with yourself in isolation from the build and its mission.\n\nYou may have abandoned something within you that's essential to being able to complete the build to its best realization. You may have lost the ability to tune in to the messages and inner-sense that are there to guide you.\n\nIf this feels correct, take that time to reset and listen. A pivot is neccessary but it must come from a real place, detached from egoic desires, fears and projections.\n\nThe truth is hiding where your fears are screaming from." 
      }, // Sep 11 addition
      {
        "id": "traveler",
        "title": "The Traveler",
        ...
        "moon_meaning": "Travel is an expansive, unpredictable, exciting experience, but as with all things in life, it has an appropriate time and a season. Some folks who get into the traveler energy can find themselves craving pause, or grounding. Others may find themselves lost and aimless, simply traveling as habit or escape from something challenging emerging within themselves.\n\nThe traveler is an adventurer by nature. However, adventure is a phase of the journey. Other phases of the journey can be grounding, integration, rest and another is sharing your discoveries and bounties with others (though some may simply hoard). It's time to ask yourself if your traveling still has purpose for you at this time?\n\nIs this a season for travel, or for something else? Are you simply seeking to escape? Struggling to be with yourself? Hanging on to times past attached to an earlier version of self? Are you afraid of commiting to something arising from within, waiting to be birthed?\n\nIt's time to get honest with yourself before making your next move. The human experience has many chapters, seasons and flavors and perhaps the flavor of your next adventure is one undertaken in a different form than globetrotting." 
      },  //Updated Sep 2
      {
        "id": "curseymccurses",
        "title": "The One Who Curses",
        "image_url": "https://images.squarespace-cdn.com/content/63851693a72d772add4d6c00/8b1c205e-afc1-412a-8b14-bdc035fe6285/Dark+Witch.png",  
        "time": "The Present",
        "energy": "Destruction or Repair",
        "location": "The Shadows",
        "element": "Darkness",
