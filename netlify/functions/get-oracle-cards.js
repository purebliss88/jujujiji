  ...
  try {
    ...
    const cards = [
      ...
      },
      {
        ...
        "element": "Spirit",
        "sun_meaning": "This one is the heart-driven leader. They are the leadership style this world desperately needs to obsolesce the dominance-top down structures, and help us move into servant-leader structure as the norm.\n\nThis being is often reluctant to step into leadership as common society-approved ideas of leadership are conflated with 'rule' or ideas of dominance and control.\n\nWhen leadership is inclusive, connective and compassionate, it activates the strengths, loyalties and best performance of those in the led collective.\n\nThis leader is often one who is admired, but doesn't seek admiration. Their impact is far greater than they'll ever know, and their presence is typically seen as a gift.\n\nThe one you drew this oracle for, is - or is aligned on the path to become - a heart-driven leader whose ability of compassion and empathy elevates them beyond most, whether they know it or not.\n\nThey are talented in bringing out the absolute best in others and creating a healthy team or tribal culture grounded in connection and human-first values.",
        "moon_meaning": "This one's reluctance to step into leadership is preventing them being in the life meant for them. They are needed and it's time for them to rise up and overcome doubt.\n\nThe most influential, inspiring and transformative leaders are connected and grounded through their heart. They're not the domineering, narcisistic types seen glorified in movies - those people had their time and era.\n\nLeading with heart means facing yourself continually and growing. Speaking truth, speaking up for the others, being vulnerable and going against 'the norm'. It is not a path for the weak.\n\nThis one must lead as example, which requires a process of continual transformation and egoic refinement through shedding. While this is challenging, it's true gift is that eventually, any doubt this one has held in themself will not be able to survive.\n\nHow can it, when this one has overcome so much within themselves and is still able to be present in their heart?\n\nThis is why this one's leadership is so effective; it is rooted in lived wisdom, born through struggle and lives through capacity to hold great empathy, be in service and see with clarity. Doubt loses oxygen when this being persists." 
      },
    ];
